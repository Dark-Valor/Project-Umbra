...
public class DIGDialogueManager : MonoBehaviour
{
    [Header("UI Elements")]
    ...
    */
    ...
    private Player_Move_Update playerMovement;
    ...
    [HideInInspector]
    public DIGDialogueTrigger currentTrigger;
    ...
    {
        // This is not a great way of freezing the player, but is done because this way Player_Move_Update doesn't have to change
        if (GameObject.FindGameObjectWithTag("Player").TryGetComponent<Player_Move_Update>(out Player_Move_Update player_move))
        {
            playerMovement = player_move;
            playerMovement = GameObject.FindGameObjectWithTag("Player").GetComponent<Player_Move_Update>();
